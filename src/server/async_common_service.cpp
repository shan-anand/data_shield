...
class AsyncCommonService::CallBase : public AsyncCallBase {
 public:
  CallBase(Api::AsyncService* service, ServerCompletionQueue* cq, std::shared_ptr<CommonHelper> helper)
...
// ListApis
class AsyncCommonService::ListApisCall : public AsyncCommonService::CallBase {
 public:
...
// GetSystemInfo
class AsyncCommonService::GetSystemInfoCall : public AsyncCommonService::CallBase {
 public:
...
AsyncCommonService::AsyncCommonService(std::shared_ptr<CommonHelper> helper)
    : service_(), cq_(nullptr), helper_(helper) {}

AsyncCommonService::~AsyncCommonService() {}

void AsyncCommonService::Start(ServerCompletionQueue* cq, int initial_slots) {
  cq_ = cq;
...
void AsyncCommonService::Shutdown() {
